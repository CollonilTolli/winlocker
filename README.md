...
CollonilTolliWinLock - это шуточное приложение-винлокер, созданное на базе Electron. Приложение блокирует доступ к рабочему столу, отключает системные горячие клавиши и требует ввод пароля для разблокировки.
